...
//     if(abs(gyroRemovedBias[2]) > 2.5f){ // If gyro rate is too high
...
//         RollMotor.setSpeed(wheelSpeed * 3); // Set roll motor speed based on wheel speed command
//     }else{
