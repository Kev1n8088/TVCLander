...
//KEEP BODY TO WORLD TO MATCH OTHER IMUS
...
void Orientation::updateAccel(float x, float y, float z)
{
    Quaternion measuredAccel = Quaternion(x, y, z);
    worldAccel = orientation.rotate(measuredAccel);
}
